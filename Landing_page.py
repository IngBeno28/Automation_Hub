...
# Logo + Header - Both in the same centered container
logo = load_logo()

# Create a single centered container for both logo and text
...
# Header text - now properly aligned with the logo
